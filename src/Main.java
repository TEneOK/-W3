...
System.out.println(averageDay+" потребуется дней в среднем, чтобы добиться результата похудения.");
        ...
        long Denis = 83690;
        long Kristina = 76230;
        long salaryIncreaseMasha = (Masha+6776);
        long salaryIncreaseDenis = (Denis+8369);
        long salaryIncreaseKristina = (Kristina+7623);
        long annualIncomeMasha = (Masha*12);
        long annualIncomeDenis = (Denis*12);
        long annualIncomeKristina = (Kristina*12);
        long annualIncomeMashaNew = (salaryIncreaseMasha*12);
        long annualIncomeDenisNew = (salaryIncreaseDenis*12);
        long annualIncomeKristinaNew = (salaryIncreaseKristina*12);
